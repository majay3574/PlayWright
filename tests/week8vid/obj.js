        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        thispage = _a.sent();
                        return [2 /*return*/, { thispage: thispage, context: context, browser: browser }];
                }
            });
        });
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        thispage = (_c.sent()).thispage;
                        return [4 /*yield*/, thispage.goto("https://login.salesforce.com/")];
                    case 2:
                        _c.sent();
                        _b = (_a = console).log;
                        return [4 /*yield*/, thispage.title()];
                    case 3:
                        _b.apply(_a, [_c.sent()]);
                        return [2 /*return*/];
                }
